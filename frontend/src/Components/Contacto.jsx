  ...
  return (
    <>
      ...
      <div className="containerContacto">
        ...
        llamarnos al [número de teléfono]. Estamos disponibles durante horas de
        operación para atender tus llamadas y responder tus preguntas.
        </p>
        
        <p className= "redesContacto">
        Síguenos en Redes Sociales
        Mantente al día con nuestras últimas novedades, promociones y eventos
        siguiéndonos en nuestras redes sociales: 
        Facebook: [enlace a la página
        de Facebook] 
        Instagram: [enlace a la cuenta de Instagram] 
        </p>
       
        < p className= "horario">
        Horario de Atención Estamos abiertos
        [días de la semana] de [horario de apertura] a [horario de cierre].
